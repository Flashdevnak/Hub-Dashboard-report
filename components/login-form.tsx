  ...
  return (
    <div className="mx-auto mt-16 max-w-md rounded-[28px] border border-slate-200 bg-white p-8 shadow-sm">
      ...
      <p className="mt-2 text-sm text-slate-500">
        admin และ user ใช้ Firebase Authentication ชุดเดียวกัน
      </p>
      ...
      <div className="mt-5 flex gap-2">
        <button
          ...
          className={
            mode === "login"
              ...
              : "rounded-xl border border-slate-300 px-4 py-2 text-sm font-bold"
          }
        >
          Login
        </button>
        ...
        <button
          ...
          className={
            mode === "register"
              ? "rounded-xl bg-yellow-400 px-4 py-2 text-sm font-black text-slate-900"
              : "rounded-xl border border-slate-300 px-4 py-2 text-sm font-bold"
          }
        >
          Register
